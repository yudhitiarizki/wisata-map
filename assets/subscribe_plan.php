...
$userheaders = "From: info@travelguide.com\n";
$usermessage = "Thank you for subscribe to TravelGuide. We will reply shortly! with more details";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Thank you <strong>$firstname</strong>,<br> your message has been submitted. We will contact you shortly.";
	echo "</div>";
