...
$e_body = "You have been contacted by $name_contact $lastname_contact who fill the form $sender_name with the following message." . PHP_EOL . PHP_EOL;
...
$usermessage = "Thank you for contact $sender_name. We will reply shortly!";
mail($user,$usersubject,$usermessage,$userheaders);

if(mail($address, $e_subject, $msg, $headers)) {

	// Success message
	echo "<div id='success_page' style='padding:0 0 25px 0'>";
